classdef CST < handle
    ...
    methods
        function mesh = CST(bordes,divx,divy,C)
            [mesh.nodes, mesh.elems, mesh.bordes] = mallador_triang_CST(bordes,divx,divy);
        ...
        function mesh = armar_R(mesh, i, carga_s, carga_v, type)
                ...
                Rel = carga_CST(nodos, carga_s, carga_v, "coordenada", type);
       ...
       function [escala] = dibujar(mesh,porcien)
            ...
            % sin deformar
            figure(2)
            draw_Mesh(mesh.elems,mesh.nodes, 'NodeLabel',true,'Type','CST','Color','b')
            hold off
            ...
            figure(3)
            draw_Mesh(mesh.elems,mesh.nodes,'Type','CST','Color','b')
            hold on
