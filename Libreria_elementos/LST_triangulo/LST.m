classdef LST < handle
    ...
    methods
        function mesh = LST(bordes,divx,divy,C)
            [mesh.nodos.coordenadas, mesh.elems, mesh.bordes] = mallador_triang_LST(bordes,divx,divy);
        ...
        function mesh = armar_K(mesh)
            ...
            for i = 1:mesh.counts.nelem
                ...
                Kel = crearK_LST(coord, mesh.material.C);
        ...
        function mesh = armar_R(mesh, i, carga_s, carga_v, type)
                ...
                Rel = carga_LST(coord, carga_s, carga_v, "coordenada", type);
        ...
        function mesh = armar_M(mesh,p)
            ...
            for i = 1:mesh.counts.nelem
                ...
                Mel = masa_LST(coord, mesh.material.rho,1);
        ...
        function [escala] = dibujar(mesh,porcien)
            ...
            % sin deformar
            figure(2)
            draw_Mesh(mesh.elems,mesh.nodos.coordenadas, 'NodeLabel',true,'Type','LST','Color','b')
            hold off
            ...
            figure(3)
            draw_Mesh(mesh.elems,mesh.nodos.coordenadas,'Type','LST','Color','b')
            hold on
        ...
        function mesh = dibujar_frecuencias(mesh)
            ...
            for i = [1 2 3]
                ...
                coord = [x y];
                draw_Mesh(mesh.elems,coord,'Type','LST','Color',color(i))
            end
        end
    end
